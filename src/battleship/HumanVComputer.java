...
public class HumanVComputer {
    ...
    public static void main(String args[]) {
        ...
        BattleshipPlayer opponent = new jrivera2_BattleshipPlayer();
    
        Board computerBoard = opponent.hideShips();
        ...
        while (!humanBoard.isComplete() && !computerBoard.isComplete()) {
